// The code comes from https://github.com/mrdoob/three.js/blob/dev/examples/jsm/postprocessing/Pass.js
...
// The code comes from https://github.com/N8python/n8ao/blob/master/dist/N8AO.js

//import {
//    Color as $5Whe3$Color, WebGLRenderTarget as $5Whe3$WebGLRenderTarget, LinearFilter as $5Whe3$LinearFilter, NearestFilter as $5Whe3$NearestFilter, DepthTexture as $5Whe3$DepthTexture,
//    UnsignedIntType as $5Whe3$UnsignedIntType, DepthFormat as $5Whe3$DepthFormat, DataTexture as $5Whe3$DataTexture, NoColorSpace as $5Whe3$NoColorSpace,
//    RepeatWrapping as $5Whe3$RepeatWrapping, Vector2 as $5Whe3$Vector2, WebGLMultipleRenderTargets as $5Whe3$WebGLMultipleRenderTargets, RedFormat as $5Whe3$RedFormat,
//    FloatType as $5Whe3$FloatType, RGBAFormat as $5Whe3$RGBAFormat, HalfFloatType as $5Whe3$HalfFloatType, ShaderMaterial as $5Whe3$ShaderMaterial, Vector3 as $5Whe3$Vector3,
//    BufferGeometry as $5Whe3$BufferGeometry, BufferAttribute as $5Whe3$BufferAttribute, Sphere as $5Whe3$Sphere, OrthographicCamera as $5Whe3$OrthographicCamera, Mesh as $5Whe3$Mesh,
//    Matrix4 as $5Whe3$Matrix4
//} from "three";
//import { Pass as $5Whe3$Pass } from "three/examples/jsm/postprocessing/Pass.js";
//import { Pass as $5Whe3$Pass1 } from "postprocessing";
const $5Whe3$Color = THREE.Color;
const $5Whe3$WebGLRenderTarget = THREE.WebGLRenderTarget;
const $5Whe3$LinearFilter = THREE.LinearFilter;
const $5Whe3$NearestFilter = THREE.NearestFilter;
const $5Whe3$DepthTexture = THREE.DepthTexture;
const $5Whe3$UnsignedIntType = THREE.UnsignedIntType;
const $5Whe3$DepthFormat = THREE.DepthFormat;
const $5Whe3$DataTexture = THREE.DataTexture;
const $5Whe3$NoColorSpace = THREE.NoColorSpace;
const $5Whe3$RepeatWrapping = THREE.RepeatWrapping;
const $5Whe3$Vector2 = THREE.Vector2;
const $5Whe3$WebGLMultipleRenderTargets = THREE.WebGLMultipleRenderTargets;
const $5Whe3$RedFormat = THREE.RedFormat;
const $5Whe3$FloatType = THREE.FloatType;
const $5Whe3$RGBAFormat = THREE.RGBAFormat;
const $5Whe3$HalfFloatType = THREE.HalfFloatType;
const $5Whe3$ShaderMaterial = THREE.ShaderMaterial;
const $5Whe3$Vector3 = THREE.Vector3;
const $5Whe3$BufferGeometry = THREE.BufferGeometry;
const $5Whe3$BufferAttribute = THREE.BufferAttribute;
const $5Whe3$Sphere = THREE.Sphere;
const $5Whe3$OrthographicCamera = THREE.OrthographicCamera;
const $5Whe3$Mesh = THREE.Mesh;
const $5Whe3$Matrix4 = THREE.Matrix4;
const $5Whe3$Pass = THREE.Pass;
const $5Whe3$Pass1 = POSTPROCESSING.Pass;
...
THREE.N8AOPostPass = $87431ee93b037844$export$2489f9981ab0fa82;